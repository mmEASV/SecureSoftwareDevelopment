...
using Admin.Web.Shared.Components.Base;
using Microsoft.AspNetCore.Components;
using Microsoft.AspNetCore.Components.Web;
using Microsoft.JSInterop;

namespace Admin.Web.Shared.Components.CustomForm;
...
public partial class CustomEditForm<T> : CustomComponentBase
{
    ...
    private void OnOpenDeleteDialog()
    {
        ...
        parameters.Add(nameof(Admin.Web.Shared.Components.Modals.DeleteConfirmationModal.OnDeleteConfirmed),
        ...
        ModalService.Show<Admin.Web.Shared.Components.Modals.DeleteConfirmationModal>("Delete Confirmation", parameters, options);
    }
