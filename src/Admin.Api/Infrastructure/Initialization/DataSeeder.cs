...
public static class DataSeeder
{
    ...
    {
        // Seed client first (always check if client needs seeding, independent of other data)
        if (!await context.Clients.AnyAsync())
        {
            var defaultClient = new Client
            {
                ...
                Description = "Default client for local development - points to ClientPortal.Api webhook endpoint",
                WebhookUrl = "https://localhost:7200/api/webhooks/release-notification",
        ...
        // Check if updates/releases already exist
